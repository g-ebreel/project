...
$insert = mysqli_query($db,"INSERT INTO `users`(`username`,`phone`,`password`,`code`,`status`)
VALUES('$username','$formatPhone','$encpass','$code','pending')");

if($insert){ 
    $message = "Hello ".$username.".Am Gebreel follow me on Ig Gebreel jamal_ke and your passcode is ".$code;
    // $message = "Hello ".$username.".Am Gebreel and your passcode is ".$code;
    $sms = new SendSMS();
    $sms->sendMessage($formatPhone,$message);
    die("Account successfuly created!");
